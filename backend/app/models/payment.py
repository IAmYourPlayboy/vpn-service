...
from sqlalchemy import DateTime, CheckConstraint, ForeignKey, Numeric, String, text
...
class Payment(Base):
    ...
    __table_args__ = (
        CheckConstraint("provider IN ('cryptomus', 'robokassa', 'yookassa')", name="ck_payment_provider"),
    )
